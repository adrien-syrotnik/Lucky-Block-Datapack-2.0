...
execute as @e[type=turtle,limit=1,sort=nearest] at @s run scoreboard players set @s music 1
execute as @e[type=turtle,limit=1,sort=nearest] at @s run function lb:effects/bcs_music
