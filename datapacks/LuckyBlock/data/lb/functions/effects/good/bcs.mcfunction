...
execute as @e[type=turtle,distance=..2,sort=nearest] at @s run scoreboard players set @s music 1
execute as @e[type=turtle,distance=..2,sort=nearest] at @s run function lb:effects/bcs_music

scoreboard players set @e[type=turtle,distance=..2,sort=nearest] count 315
