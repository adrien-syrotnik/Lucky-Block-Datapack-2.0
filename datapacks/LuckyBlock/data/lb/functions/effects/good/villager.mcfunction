...
execute if score @s RANDOM matches 0 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:armorer"
execute if score @s RANDOM matches 1 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:butcher"
execute if score @s RANDOM matches 2 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:cartographer"
execute if score @s RANDOM matches 3 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:cleric"
execute if score @s RANDOM matches 4 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:farmer"
execute if score @s RANDOM matches 5 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:fisherman"
execute if score @s RANDOM matches 6 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:fletcher"
execute if score @s RANDOM matches 7 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:leatherworker"
execute if score @s RANDOM matches 8 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:librarian"
execute if score @s RANDOM matches 9 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:mason"
execute if score @s RANDOM matches 10 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:nitwit"
execute if score @s RANDOM matches 11 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:shepherd"
execute if score @s RANDOM matches 12 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:toolsmith"
execute if score @s RANDOM matches 13 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.profession set value "minecraft:weaponsmith"
...
execute if score @s RANDOM matches 0 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.type set value "minecraft:desert"
execute if score @s RANDOM matches 1 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.type set value "minecraft:jungle"
execute if score @s RANDOM matches 2 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.type set value "minecraft:plains"
execute if score @s RANDOM matches 3 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.type set value "minecraft:savanna"
execute if score @s RANDOM matches 4 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.type set value "minecraft:snow"
execute if score @s RANDOM matches 5 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.type set value "minecraft:swamp"
execute if score @s RANDOM matches 6 run data modify entity @e[type=villager,limit=1,sort=nearest,tag=!isdone] VillagerData.type set value "minecraft:taiga"

tag @e[type=villager,limit=1,sort=nearest,tag=!isdone] add isdone
