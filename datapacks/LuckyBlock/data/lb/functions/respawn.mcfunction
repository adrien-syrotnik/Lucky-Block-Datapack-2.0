...
execute as @a[scores={checkpoint_valid=1}] at @s run function lb:spawnpoint
execute as @a[scores={checkpoint_valid=1}] at @s run tellraw @a ["",{"text":"[LuckyBlock] ","color":"dark_red"},{"selector":"@s","color":"gold"},{"text":" has reach a checkpoint."}] 
