...
#tellraw new score
execute as @a[scores={Position=1}] run tellraw @a ["",{"text":"[Lucky Block] ","color":"dark_red"},{"selector":"@p[scores={Position=1}]","color":"dark_red"},{"text":" achieved a new record with this configuration: ","color":"gold"},{"score":{"name":"level0weight","objective":"maxweightstage"},"color":"dark_green"},{"text":"/","color":"gold"},{"score":{"name":"level1weight","objective":"maxweightstage"},"color":"dark_green"},{"text":"/","color":"gold"},{"score":{"name":"level2weight","objective":"maxweightstage"},"color":"dark_green"},{"text":"/","color":"gold"},{"score":{"name":"level3weight","objective":"maxweightstage"},"color":"dark_green"},{"text":" : ","color":"gold"},{"score":{"name":"@p[scores={Position=1}]","objective":"minutes"},"color":"dark_red"},{"text":":","color":"gold"},{"score":{"name":"@p[scores={Position=1}]","objective":"secondes"},"color":"dark_red"},{"text":":","color":"gold"},{"score":{"name":"@p[scores={Position=1}]","objective":"centieme"},"color":"dark_red"}]
