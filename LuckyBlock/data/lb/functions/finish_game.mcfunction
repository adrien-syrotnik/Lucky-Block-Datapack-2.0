...
execute if score @e[name="GameManager",limit=1,type=armor_stand] nbplayers = abandons nbplayers run tellraw @a ["",{"text":"[Lucky Block] ","color":"gold"},{"text":"The game is finished and... everyone has abandoned the game :( cringe!","color":"gold"}]
execute unless score @e[name="GameManager",limit=1,type=armor_stand] nbplayers = abandons nbplayers run tellraw @a ["",{"text":"[Lucky Block] ","color":"gold"},{"text":"All players finished the game! Congratulations to the winner: ","color":"gold"},{"selector":"@p[scores={finish=1,abandon=0}]","color":"dark_red"},{"text":" !!!","color":"gold"}]
