...
execute if score @s RANDOM matches 0 run effect give @s minecraft:night_vision 20 100 true
execute if score @s RANDOM matches 1 run effect give @s minecraft:water_breathing 20 100 true
execute if score @s RANDOM matches 2 run effect give @s minecraft:fire_resistance 10 100 true
execute if score @s RANDOM matches 3 run effect give @s minecraft:speed 5 0 true
execute if score @s RANDOM matches 4 run effect give @s minecraft:slowness 5 0 true
...
execute if score @s RANDOM matches 13 run effect give @s minecraft:regeneration 3 0 true
execute if score @s RANDOM matches 14 run effect give @s minecraft:instant_health 1 0 true

execute if score @s RANDOM matches 15 run effect give @s minecraft:night_vision 20 100 true
execute if score @s RANDOM matches 15 run effect give @s minecraft:water_breathing 20 100 true
execute if score @s RANDOM matches 15 run effect give @s minecraft:fire_resistance 10 100 true
execute if score @s RANDOM matches 15 run effect give @s minecraft:speed 5 0 true
execute if score @s RANDOM matches 15 run effect give @s minecraft:slowness 5 0 true
...
execute if score @s RANDOM matches 15 run effect give @s minecraft:regeneration 3 0 true
execute if score @s RANDOM matches 15 run effect give @s minecraft:instant_health 1 0 true
