...
execute as @a[scores={kit=2,on_death=2}] at @s run function lb:kits/effects/pretre_effect

execute as @a[scores={on_death=1}] at @s unless score @s kit matches 2 as @a[scores={kit=2}] at @s run function lb:kits/effects/necromancien
